...
class PointNetSetAbstraction(nn.Module):
    def __init__(self, npoint, radius, nsample, in_channel, mlp, group_all):
        ...
        Input:
            ...
            in_channel: dimention of channel
            mlp: mlp input-ouput channel
            group_all: boolean for sample_and_group_all
        """
    ...
    def query_ball_point(radius, nsample, xyz, new_xyz):
        ...
        sqrdists = self.square_distance(new_xyz, xyz) # get distance to get nsample 
    ...
    def farthest_point_sample(xyz, npoint):
        """
        Discribe:
            use FPS to get those points' index 
        Input:
    ...
    def sample_and_group(npoint, radius, nsample, xyz, points, returnfps=False):
        ...
        B, N, C = xyz.shape
        S = npoint
        fps_idx = self.farthest_point_sample(xyz, npoint) # [B, npoint, C]
    ...
    def sample_and_group_all(xyz, points):
        """
        Discribe:
            Sampling all points as a group
        Input:
            xyz: input points position data, [B, N, 3]
            points: input points data, [B, N, D]
        Return:
...
group_all=False)
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=256 + 3, mlp=[256, 512, 
1024], group_all=True)
